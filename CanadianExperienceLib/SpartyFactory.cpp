...
std::shared_ptr<Actor> SpartyFactory::Create(std::wstring imagesDir)
{
    ...
    auto lightsaber = std::make_shared<ImageDrawable>(L"Lightsaber", imagesDir +L"/lightsaber.png");
    lightsaber->SetCenter(wxPoint(500, 200));
    lightsaber->SetPosition(wxPoint(-60, 120));
