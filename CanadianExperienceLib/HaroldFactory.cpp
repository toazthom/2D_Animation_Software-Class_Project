...
std::shared_ptr<Actor> HaroldFactory::Create(std::wstring imagesDir)
{
    ...
    auto lightsaber = std::make_shared<ImageDrawable>(L"Lightsaber", imagesDir +L"/lightsaber_red.png");
    lightsaber->SetCenter(wxPoint(17, 20));
    lightsaber->SetPosition(wxPoint(-9, 100));
    rarm->AddChild(lightsaber);
